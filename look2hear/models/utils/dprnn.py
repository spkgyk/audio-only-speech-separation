...
class DPRNN(nn.Module):
    def __init__(self, input_size, hidden_size, output_size, dropout=0, num_layers=1, bidirectional=True):
...
class GC_DPRNN(nn.Module):
    def __init__(self, input_size, hidden_size, output_size, num_group=2, dropout=0, num_layers=1, bidirectional=True):
...
class Unfolded_DPRNN(nn.Module):
    def __init__(self, input_size, hidden_size, output_size, dropout=0, num_layers=1, bidirectional=True):
        super(Unfolded_DPRNN, self).__init__()
